...
function withAuthHeader(Component) {
  ...
  return function (props) {
    if (!!value.auth && (0, _utils.isAuthenticated)(value)) {
      return (0, _jsxRuntime.jsx)(Component, _objectSpread(_objectSpread({}, props), {}, {
        authHeader: "".concat(value.auth.type, " ").concat(value.auth.token)
      }));
    } else {
      return (0, _jsxRuntime.jsx)(Component, _objectSpread(_objectSpread({}, props), {}, {
        authHeader: ""
...
var _default = exports.default = withAuthHeader;